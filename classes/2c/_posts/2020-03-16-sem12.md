...
{: .box-note}
<span style="color: #2980b9;"><i class="fas fa-comment-dots"  aria-hidden="true"></i></span> **contenus** cours : Pour tout vecteur \\(\overrightarrow{u}\\) et \\(\overrightarrow{v}\\) et réels \\(a\\) et \\(b\\) :  
...
**déroulement** cours : Pour tout vecteur \\(\overrightarrow{u}\\) et \\(\overrightarrow{v}\\) et réels \\(a\\) et \\(b\\) :
- \\(a(b\overrightarrow{u})  = (ab)\overrightarrow{u} \\)
- \\((a+b)\overrightarrow{u} = a\overrightarrow{u}+b\overrightarrow{u} \\)
- \\(a(\overrightarrow{u}+\overrightarrow{v})=a\overrightarrow{u}+a\overrightarrow{v} \\) 
